...
// GET - View document inline with smart filename (for iframe)
export async function GET(_request: NextRequest, { params }: RouteParams) {
  try {
    ...
    // Return file with Content-Disposition: inline for viewing in iframe
    // The filename will be used if user saves from the browser's PDF viewer
