  ...
  try {
    ...
    if (body.status === "archived") {
      ...
      if (docRows.length > 0) {
        ...
        // Move from to-file/ or review/ to archive/
        if (currentPath.startsWith("to-file/") || currentPath.startsWith("review/")) {
          const newPath = currentPath.replace(/^(to-file|review)\//, "archive/");
          try {
