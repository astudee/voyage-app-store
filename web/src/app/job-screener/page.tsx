  ...
  async function handleFetchApplicants() {
    ...
    try {
      ...
      if (!contentType.includes('application/json')) {
        throw new Error(
          res.status === 504
            ? 'Request timed out — this job has too many applicants. Try again.'
        ...
        {applicantsLoading && (
          <div className="flex items-center gap-3 text-slate-500 py-12 justify-center">
            ...
            <span className="text-sm">
              Fetching applicants and enriching profiles…
            </span>
          </div>
        )}
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-slate-50 border-b border-slate-200">
                      ...
                      <TableHead className={thClass}>LinkedIn</TableHead>
                      <TableHead className={thClass}>Resume</TableHead>
                      <TableHead
                        className={thClass}
                        ...
                        <>{/* Bucket header row */}
                          ...
                          {!collapsed &&
                            rows.map((a) => (
                              ...
                              >
                                {/* Name */}
                                <TableCell className={`${tdClass} font-medium text-slate-900 min-w-[140px]`}>
                                  {a.name}
                                  {a.email && (
                                ...
                                {/* Education */}
                                <TableCell className={`${tdClass} min-w-[180px] text-xs`}>
                                  {formatEducation(a.education)}
                                </TableCell>
